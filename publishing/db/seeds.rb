...
eq_1_1 = LineInput.create(inputable: eq_1, prefix: "", suffix: "")
...
grouping_by_10 = Section.create(title: 'Grouping by 10', active: true, description: '10 by 10', chapter: positional_system, meijerink_criteria: {"1F" => "1", "2F" => "0", "3F" => "0"})
position_of_0 = Section.create(title: 'Position of the 0', active: true, description: 'at the back or at the front?', chapter: positional_system, meijerink_criteria: {"1F" => "1", "2F" => "1", "3F" => "1"})

## Basic operations
addition = Section.create(title: 'Addition', description: '2+2=5 for the majority of values of 2', chapter: basic_operations, meijerink_criteria: {"1F" => "1", "2F" => "1", "3F" => "0"})
subtraction = Section.create(title: 'Subtraction', description: 'Too many things, let me get rid of some', chapter: basic_operations, meijerink_criteria: {"1F" => "1", "2F" => "1", "3F" => "1"})
