...
grouping_question_1 = Question.create(text: "Grouping question 1 text", worked_out_answer: "Something something here", section: grouping_by_10)
...
grouping_question_2 = Question.create(text: "Grouping question 2 text", worked_out_answer: "This is supposed to explain", section: grouping_by_10)
