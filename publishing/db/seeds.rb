...
grouping_question_1 = Question.create(text: "Grouping question 1 text", explanation: "Something something here", section: grouping_by_10)
...
grouping_question_2 = Question.create(text: "Grouping question 2 text", explanation: "This is supposed to explain", section: grouping_by_10)
...
grouping_question_3 = Question.create(text: "Grouping question 3 text", explanation: "Content, more content!", section: grouping_by_10)
