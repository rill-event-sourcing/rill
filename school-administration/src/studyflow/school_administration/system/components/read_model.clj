(ns studyflow.school-administration.system.components.read-model
  (:require [com.stuartsierra.component :refer [Lifecycle]]
            [studyflow.school-administration.read-model :refer [empty-model]]
            [studyflow.school-administration.read-model.event-listener :refer [listen!]]
